...
function CheckTable(props: { tableData: any }) {
  ...
  const columns = [
    ...
    columnHelper.accessor('menu', {
      id: 'menu',
      header: () => (
        <p className="fxst-bold text-sm text-foreground dark:text-white"></p>
      ),
            ...
            {table
              ...
              .map((row) => {
                return (
                  <TableRow
                    key={row.id}
                    className="px-6 dark:hover:bg-zinc-800"
                  >
        ...
        <div className="mt-2 flex h-20 w-full items-center justify-between px-6">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* {createPages(table.getPageCount()).map((pageNumber, index) => {
              return (
                <Button
                  className={`font-mediumflex items-center justify-center rounded-md p-0 p-2 text-sm transition duration-200 ${
            ...
            {/* <Button
              onClick={() => table.nextPage()}
              disabled={!table.getCanNextPage()}
              className={`flex items-center justify-center rounded-md bg-transparent p-2 text-lg font-medium text-foreground transition duration-200 hover:bg-transparent active:bg-transparent dark:text-white dark:hover:bg-transparent dark:active:bg-transparent`}
            >
              <MdChevronRight />
            </Button> */}
          </div>
