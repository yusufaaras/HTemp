...
export default function ForgotPassword({ allowEmail, redirectMethod }: ForgotPasswordProps) {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        await handleRequest(e, requestPasswordUpdate, redirectMethod === 'client' ? router : null); // Koşulsuz kullanım
    ...
    return (
        <div className="mb-8">
            ...
            {allowEmail && (
                <p>
                    <Link href="/dashboard/signin/email_signin" className="font-medium text-sm dark:text-white">
