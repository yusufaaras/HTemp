...
function Sidebar(props: SidebarProps) {
    ...
    return (
        <div
            className={`lg:!z-99 fixed !z-[99] min-h-full w-[300px] transition-all md:!z-[99] xl:!z-0 ${props.variant === 'auth' ? 'xl:hidden' : 'xl:block'} ${open ? '' : '-translate-x-[120%] xl:translate-x-[unset]'}`}
        >
            <Card className={`m-3 ml-3 h-[96.5vh] w-full overflow-hidden !rounded-md border-zinc-200 pe-4 dark:border-zinc-800 sm:my-4 sm:mr-4 md:m-5 md:mr-[-50px]`}>
                <Scrollbars
                    autoHide
                    ...
                    <div className="flex h-full flex-col justify-between">
                        ...
                        <div className="mb-9 mt-7">
                            ...
                            <div className="mt-5 flex w-full items-center rounded-md border border-zinc-200 p-4 dark:border-zinc-800">
                                ...
                                <form
                                    className="w-full"
                                    onSubmit={(e) => handleRequest(e, SignOut, getRedirectMethod() === 'client' ? router : null)} // Koşulsuz kullanım
                                >
